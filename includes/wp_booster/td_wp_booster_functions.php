...
function td_deactivate_old_plugins() {
    ...
    //todo - remove this check when the globals are defined on each plugin?
	...
	$deploy_datetime = '___td-deploy-datetime___'; //not sure what we'll do with this
	$td_plugins = array(
		'TD_COMPOSER' => '0354e321a29d3ef23bcc498e9887b7ec',
		'TD_TEMPLATE_BUILDER' => '1113d929157500a11b59833ee9cfa588',
		'TD_SOCIAL_COUNTER' => '2b2f61495f2d470772662d2445f892ab',
		'TD_NEWSLETTER' => 'c914bd9ddc05a62a9cfe1a241e85c348',
		'TD_AMP' => '137cd38a3e6f9fa8599452966fb1b297',
		'TD_MOBILE_PLUGIN' => '6744d78cb08fb46c9ae845e7a8cb6dc8'
	);

	foreach ($td_plugins as $constant => $version) {
