...
//	    ));
    ...
    if (extension_loaded('mbstring')) {
        ...
        td_system_status::add('php.ini configuration', array(
            ...
            'value' => 'not available - For details on how to enable this extension please check the <a target="_blank" href="https://forum.tagdiv.com/' . (TD_THEME_NAME === "Newspaper" ? "requirements-for-newspaper" : "requirements-for-newsmag") . '/#td-ss-parameters-guide">System status parameters guide</a>',
            'status' => 'red'
        ));
    }
    ...
    if (extension_loaded('gd')) {
	    td_system_status::add('php.ini configuration', array(
		    'check_name' => 'gd',
		    'tooltip' => 'GD extension is loaded. The theme uses it\'s functions for various image related operations.',
		    'value' => 'available',
		    'status' => 'green'
	    ));
    } else {
	    td_system_status::add('php.ini configuration', array(
		    'check_name' => 'gd',
		    'tooltip' => 'GD extension is not available. The theme uses it\'s functions for various image related operations.',
		    'value' => 'not available - For details on how to enable this extension please check the <a target="_blank" href="https://forum.tagdiv.com/' . (TD_THEME_NAME === "Newspaper" ? "requirements-for-newspaper" : "requirements-for-newsmag") . '/#td-ss-parameters-guide">System status parameters guide</a>',
		    'status' => 'red'
	    ));
    }
