...
if ( is_plugin_active('td-template-builder/td-template-builder.php' ) ) {
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">TDB template</span>
        <p>Set a <a href="<?php echo admin_url( 'edit.php?post_type=tdb_templates' ) ?>">WP Templates</a> builder category template for this category.</p>
    </div>
...
/*
        $text = 'the tdb category template is NOT set!! ';
        $style = 'color: green;';

        if ( $tdb_category_template_is_set ) {
            $style = 'color: red;';
            $text = 'the tdb category template is set!! ';
        }

        echo '<span class="tdb-cat-template-check" style="' . $style . ' display: list-item;" >' . $text . '</span>';
*/
